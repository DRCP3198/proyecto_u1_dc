...
public class CuentaBancariaRepositoryImpl implements ICuentaBancariaRepository{
	...
	public void actualizar(CuentaBancaria cuentaBancaria) {
		...
		for (CuentaBancaria cb : baseCuentas) {//la lista que es mi base de datos
			if (cb.getNumero().equals(cuentaBancaria.getNumero())) { //Si es igual al numero de cuenta hace la comparacion
				cuenta=cb; //Cuando la encuentre
